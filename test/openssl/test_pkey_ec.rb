...
class OpenSSL::TestPKeyEC < Test::Unit::TestCase
  ...
  def test_ecdh_kdf_ansi_x963_sha256_default_size
    group = OpenSSL::PKey::EC::Group.new('prime256v1')
    ecdh = OpenSSL::PKey::EC.new(group)
    ecdh.generate_key
    ecdh2 = OpenSSL::PKey::EC.new(group)
    ecdh2.generate_key
    ecdh_secret = ecdh.dh_compute_key(ecdh2.public_key,
                  &OpenSSL::PKey::KeyDerivation.ansi_x963(OpenSSL::Digest::SHA256.new))
    ecdh2_secret = ecdh2.dh_compute_key(ecdh.public_key,
                   &OpenSSL::PKey::KeyDerivation.ansi_x963(OpenSSL::Digest::SHA256.new))
    assert_equal(32, ecdh_secret.bytesize)
    assert_equal(32, ecdh2_secret.bytesize)
    assert_equal(ecdh_secret, ecdh2_secret)
  end
  ...
  def test_ecdh_kdf_ecc_cms_shared_info_sha_256
    ...
    ecdh_secret = ecdh.dh_compute_key(ecdh2.public_key,
                  128,
                  &OpenSSL::PKey::KeyDerivation.ecc_cms_shared_info("2.16.840.1.101.3.4.1.5", OpenSSL::Digest::SHA256.new))
    ecdh2_secret = ecdh2.dh_compute_key(ecdh.public_key,
                  128,
                  &OpenSSL::PKey::KeyDerivation.ecc_cms_shared_info("2.16.840.1.101.3.4.1.5", OpenSSL::Digest::SHA256.new))
    assert_equal(16, ecdh_secret.bytesize)
  ...
  def test_ecdh_kdf_ecc_cms_shared_info_sha_256_default_size
    group = OpenSSL::PKey::EC::Group.new('prime256v1')
    ecdh = OpenSSL::PKey::EC.new(group)
    ecdh.generate_key
    ecdh2 = OpenSSL::PKey::EC.new(group)
  ...
  def test_ecdh_kdf_nist_800_56a_concatenation_sha_256
    ...
    ecdh_secret = ecdh.dh_compute_key(ecdh2.public_key,
                  128,
                  &OpenSSL::PKey::KeyDerivation.nist_800_56a_concatenation(OpenSSL::Digest::SHA256.new, 'otherinfo'))
    ecdh2_secret = ecdh2.dh_compute_key(ecdh.public_key,
                  128,
                  &OpenSSL::PKey::KeyDerivation.nist_800_56a_concatenation(OpenSSL::Digest::SHA256.new, 'otherinfo'))
    assert_equal(16, ecdh_secret.bytesize)
  ...
  def test_ecdh_kdf_nist_800_56a_concatenation_sha_256_default_size
    group = OpenSSL::PKey::EC::Group.new('prime256v1')
    ecdh = OpenSSL::PKey::EC.new(group)
    ecdh.generate_key
    ecdh2 = OpenSSL::PKey::EC.new(group)
  ...
  def test_no_size_static
    ...
    static2 = OpenSSL::PKey::EC.new(group)
    static2.generate_key
    ecdh_secret = ecdh.dh_compute_key(ecdh2.public_key, nil, static, static2.public_key)
    assert_equal(20, ecdh_secret.bytesize) #sha1 20 bytes
    ecdh2_secret = ecdh2.dh_compute_key(ecdh.public_key, nil, static2, static.public_key)
    assert_equal(20, ecdh2_secret.bytesize)
    assert_equal(ecdh_secret, ecdh2_secret)
  end

  def test_obtain_raw_secret
    group = OpenSSL::PKey::EC::Group.new('prime256v1')
    ecdh = OpenSSL::PKey::EC.new(group)
    ecdh.generate_key
    ecdh2 = OpenSSL::PKey::EC.new(group)
    ecdh2.generate_key
    raw_secret = ecdh.dh_compute_key(ecdh2.public_key)
    ecdh2_secret = ecdh2.dh_compute_key(ecdh.public_key) do |secret, size=nil|
      assert_nil(size)
      secret
    end
    assert_equal(raw_secret, ecdh2_secret)
  end
