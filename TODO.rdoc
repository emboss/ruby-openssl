...
make this a separate method instead of the ugly if type == ... in
declare_prim or supply optionally parser and decoder to declare_prim
...
* Tests for default of primitives
