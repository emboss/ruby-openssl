...
=== asn1_object_id
Leave their value as OpenSSL::ASN1::ObjectId instead of setting
only the string value. Otherwise equality tests are only
possible when creating temporary ObjectIds
...
Should be possible with PKey directly?
