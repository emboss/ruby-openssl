...
=== segfault when parsing arbitrary data with OpenSSL::ASN1.decode
Encountered a segfault when trying to decode HTML. Reproduce and
fix.
...
Experiment with thread pool and pool sizes.